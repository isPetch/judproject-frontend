 ...
 <div class="min-h-screen  from-indigo-100 bg-gray-50 flex flex-col">
  ...
  <div class="bg-white rounded-lg shadow-md p-4">
    ...
    <div class="flex justify-center space-x-4 items-center">
      <button @click="addCreateProject" :disabled="isSubmitDisabled" class="bg-blue-600 text-white px-6 py-3 rounded-lg shadow-md text-lg font-bold hover:bg-blue-700" :class="{'bg-gray-400 cursor-not-allowed': isSubmitDisabled}">Save Change</button>
