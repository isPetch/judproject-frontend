      ...
      <div class="w-full max-w-2xl">
        ...
        <div class="space-y-4">
          <div>
            ...
            <input v-model="projectName" type="text" class="w-full p-3 border rounded-lg shadow-sm focus:ring focus:ring-blue-300" :class="{'border-red-500': !projectName.trim() && isSubmitDisabled}" />
          </div>

          <div>
            <label class="block font-semibold text-gray-700">Project Description</label>
            <textarea v-model="projectDescription" class="w-full p-3 border rounded-lg shadow-sm h-32 focus:ring focus:ring-blue-300" :class="{'border-red-500': !projectDescription.trim() && isSubmitDisabled}"></textarea>
          </div>
        </div>
